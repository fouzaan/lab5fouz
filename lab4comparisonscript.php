...
<br>
<p>Like other programming languages PHP has the usual methods for control flow. This includes if/else statements and the
	standard operators. There comparison operators are ==, !=, <, <=,>=.</p>
<?php
...
<table>
	...
	<tr>
		...
		<td>
			<?php echo $greaterThan ? 'true' : 'false'; ?>
		</td>
	</tr>
	<tr>
		<td>
	...
	<tr>
		...
		<td>
			<?php echo $greaterThanOrEqual ? 'true' : 'false'; ?>
		</td>
	</tr>
	<tr>
		<td>
			...
			<= <?php echo $num2; ?></td>
		<td>
			<?php echo $lessThanOrEqual ? 'true' : 'false'; ?>
		</td>
	</tr>
