...
<br>
<p>PHP has all the usual arithmetic operators: +, -, *, /, and %. The following script demonstrates PHP at work. The
	calculation in the table is made using php script itself please see the code or more</p>
<table>
